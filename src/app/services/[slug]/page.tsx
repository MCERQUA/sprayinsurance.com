...
import { ShieldCheck, HardHat, Truck, Wrench, Umbrella, Package, Droplets, CheckCircle2, ArrowRight, ArrowLeft, Users, Target } from "lucide-react";

const ICONS = { ShieldCheck, HardHat, Truck, Wrench, Umbrella, Package, Droplets } as const;
