    ...
    >
      <nav className="container-wide flex items-center justify-between h-18 py-3">
        <Link href="/" className="flex items-center gap-2.5 group" aria-label={`${SITE.name} home`}>
          <span className="relative inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-clay shadow-warm">
            <Zap className="h-5 w-5 text-espresso" strokeWidth={2.4} />
            <span className="absolute -bottom-1 -right-1 h-3 w-3 rounded-full bg-clay border-2 border-cream" />
          </span>
