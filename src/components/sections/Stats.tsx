...
export function Stats() {
  return (
    <section className="relative overflow-hidden bg-espresso text-cream py-16 md:py-20">
      <div className="absolute inset-0 opacity-60" style={{ background: "radial-gradient(circle at 18% 30%, rgba(255,215,0,0.18) 0%, transparent 45%), radial-gradient(circle at 82% 70%, rgba(255,215,0,0.12) 0%, transparent 50%)" }} aria-hidden />
